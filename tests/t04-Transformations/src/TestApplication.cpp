...
void TestApplication::initialize()
{
    ...
    m_rotating_smile_quad_task = std::make_shared<RotatingSmileQuadTask>();
    m_two_smile_quad_task = std::make_shared<TwoSmileQuadTask>();
}
...
void TestApplication::shutdown()
{
    ...
    m_rotating_smile_quad_task.reset();
    m_two_smile_quad_task.reset();
}
...
void TestApplication::update()
{
    ...
    case 0:
        ...
        break;
    case 1:
        changeTask(std::static_pointer_cast<Task>(m_rotating_smile_quad_task));
        break;
    case 2:
        changeTask(std::static_pointer_cast<Task>(m_two_smile_quad_task));
        break;
    }
...
{
    static std::vector<std::string> sample_list({ "happy quad", "rotating happy quad", "two happy quad"});
