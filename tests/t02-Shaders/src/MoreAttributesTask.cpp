...
MoreAttributesTask::MoreAttributesTask() : Task()
{
}


MoreAttributesTask::~MoreAttributesTask()
{
}


void MoreAttributesTask::initialize()
{
    ...
    // Create program
    m_program = std::make_shared<ugly::Program>(std::filesystem::path("./data/simple_color.vert"), std::filesystem::path("./data/simple_color.frag"));
}


void MoreAttributesTask::shutdown()
{
    m_va.reset();
    m_program.reset();
}
...
void MoreAttributesTask::update()
{
}


void MoreAttributesTask::updateGui()
{
}


void MoreAttributesTask::render()
{
    m_program->use();
    m_va->bind();
