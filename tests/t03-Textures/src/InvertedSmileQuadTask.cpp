...
InvertedSmileQuadTask::InvertedSmileQuadTask() : Task()
{
}


InvertedSmileQuadTask::~InvertedSmileQuadTask()
{
}


void InvertedSmileQuadTask::initialize()
{
    float vertices[] = {
...
void InvertedSmileQuadTask::shutdown()
{
    m_va.reset();
    m_program.reset();
    m_texture0.reset();
...
void InvertedSmileQuadTask::update()
{
}


void InvertedSmileQuadTask::updateGui()
{
}


void InvertedSmileQuadTask::render()
{
    m_program->use();
