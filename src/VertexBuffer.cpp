...
ugly::VertexBuffer::VertexBuffer(size_t _size)
{
    glGenBuffers(1, &m_id);
...
void ugly::VertexBuffer::setLayout(std::shared_ptr<BufferLayout> _layout) 
{ 
    m_layout = _layout; 
}


std::shared_ptr<ugly::BufferLayout> ugly::VertexBuffer::getLayout() const 
{ 
    return m_layout; 
}
